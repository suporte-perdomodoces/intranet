    ...
    <header className="bg-white/95 backdrop-blur-md border-b border-gray-200/80 px-6 py-4 sticky top-0 z-50 shadow-sm">
      <div className="mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <img src='/images/logo-perdomo.png' className='w-16 sm:w-24' />
          <div className="hidden md:block">
            <span className="text-gray-700 font-semibold text-lg">Portal Interno</span>
            <div className="text-xs text-gray-500 font-medium">Família Perdomo Doces</div>
          </div>
        </div>
        ...
        {/* <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-3 ml-4 pl-4 border-l border-gray-200">
            <div 
              className="
                w-10 h-10 bg-gradient-to-br from-primary to-primary/80 text-white rounded-full  shadow-md
